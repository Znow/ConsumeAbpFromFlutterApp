...
namespace ConsumeAbpFromFlutterApp.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ConsumeAbpFromFlutterAppDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ConsumeAbpFromFlutterAppEfCoreEntityExtensionMappings to extend the IdentityUser entity
