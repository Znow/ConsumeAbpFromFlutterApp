...
{
    public static class ConsumeAbpFromFlutterAppEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE ConsumeAbpFromFlutterAppModuleExtensionConfigurator CLASS (in the Domain.Shared project)
